        ...
        <div class="flex-center position-ref full-height">
            @if (Route::has('login'))
                <div class="top-right links">
                    ...
                    <a href="{{ url('/home') }}" style=" font-family: 'Cairo', sans-serif !important"  >Trips</a>
            ...
            <div class="content" style="margin-top:50px;">
                <div class="title m-b-md" style="padding-botton:171px">
                    <b style=" font-style: italic; opacity: 78%;color: black;  font-family: 'Cairo', sans-serif !important"  >Travel</b>
                </div>
