...
<body style="background-image:  linear-gradient(632deg, #4158d0 -20%, #c850c0 50%, #ffcc70 88%)  ">
    <div id="app" style="height: 1011px;" >
                    ...
                    <div class="col-md-3 py-4">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item" style="background-color: darkslategray">
                                <a href="/packages/create" style="color:darkorange">Trips_Create</a>
                            </li>
                              <li class="list-group-item" style="background-color: darkslategray">
                                <a href="/booking/bookingslist" style="color:darkorange">Bookings_list</a>
                            </li>
                            @endif
                            <li class="list-group-item" style="background-color: darkslategray">
                                <a href="/packages/index" style="color:darkorange">Trips_View</a>
                            </li>
